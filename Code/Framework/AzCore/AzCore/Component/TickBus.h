...
DECLARE_EBUS_EXTERN_DLL_SINGLE_ADDRESS(TickEvents, AZCORE_API);
DECLARE_EBUS_EXTERN_DLL_SINGLE_ADDRESS(SystemTickEvents, AZCORE_API);
DECLARE_EBUS_EXTERN_DLL_SINGLE_ADDRESS(TickRequests, AZCORE_API);
