...
DECLARE_EBUS_EXTERN_DLL_SINGLE_ADDRESS(TransformInterface, AZCORE_API);
DECLARE_EBUS_EXTERN_DLL_SINGLE_ADDRESS(TransformNotification, AZCORE_API);
DECLARE_EBUS_EXTERN_DLL_MULTI_ADDRESS(TransformHierarchyInformation, AZCORE_API);
