...
namespace AZ::Debug
{
    ...
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const bool& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const float& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const double& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::s8& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::s16& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::s32& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::s64& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::u8& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::u16& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::u32& value);
    template AZ_DLL_EXPORT void Profiler::ReportCounter(const Budget* budget, const wchar_t* counterName, const AZ::u64& value);
