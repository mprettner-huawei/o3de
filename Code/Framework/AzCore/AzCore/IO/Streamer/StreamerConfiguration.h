...
namespace AZ::IO
{
    ...
    struct AZCORE_API HardwareInformation
    {
    ...
    AZCORE_API extern bool CollectIoHardwareInformation(HardwareInformation& info, bool includeAllHardware, bool reportHardware);
    AZCORE_API extern void ReflectNative(ReflectContext* context);
