...
namespace AZStd
{
    namespace MemoryToASCII
    {
        ...
        */
        ...
        AZSTD_API AZStd::string ToString(const void* memoryAddrs, AZStd::size_t dataSize, AZStd::size_t maxShowSize, AZStd::size_t dataWidth = 16, Options format = Options::Default);
    }
}
