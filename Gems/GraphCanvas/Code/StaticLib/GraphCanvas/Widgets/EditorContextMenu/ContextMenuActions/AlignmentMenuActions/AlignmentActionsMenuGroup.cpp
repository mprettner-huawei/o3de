...
namespace GraphCanvas
{
    ...
    void AlignmentActionsMenuGroup::PopulateMenu(EditorContextMenu* contextMenu)
    {
        ...
        m_alignTop->setShortcut(QKeySequence(QKeyCombination(Qt::SHIFT, Qt::Key_Up).toCombined()));
        ...
        m_alignBottom->setShortcut(QKeySequence(QKeyCombination(Qt::SHIFT, Qt::Key_Down).toCombined()));
        ...
        m_alignLeft->setShortcut(QKeySequence(QKeyCombination(Qt::SHIFT, Qt::Key_Left).toCombined()));
        ...
        m_alignRight->setShortcut(QKeySequence(QKeyCombination(Qt::SHIFT, Qt::Key_Right).toCombined()));
